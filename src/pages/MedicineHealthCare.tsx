import { medicineDegrees } from '@/data/Medicine';
import { ArrowLeft, Stethoscope, TrendingUp, Users, Target } from 'lucide-react';
import { Link } from 'react-router-dom';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { CourseCard } from '@/components/Course';

export default function MedicineHealthcare() {
  const totalDegrees = medicineDegrees.length;
  const highDemandDegrees = medicineDegrees.filter(d => d.marketDemand.level === 'High').length;
  const avgSalaryRange = {
    min: Math.min(...medicineDegrees.map(d => d.salaryProgression.entryLevel)),
    max: Math.max(...medicineDegrees.map(d => d.salaryProgression.senior))
  };
        ...
        <div className="relative container mx-auto px-4 py-16">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground leading-tight">
              ...
              <span className="block text-primary mt-2">Medicine & Healthcare</span>
            </h1>
            
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Explore comprehensive career paths in medicine and healthcare. From traditional MBBS to specialized therapy degrees, 
              discover detailed insights into market demand, salary progression, and future growth prospects.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              to help you make informed decisions about your healthcare career.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {medicineDegrees.map((degree) => (
