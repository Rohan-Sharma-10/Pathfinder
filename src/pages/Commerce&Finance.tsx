import { commerceDegrees } from '@/data/Commerce';
import { ArrowLeft, Calculator, TrendingUp, Users, Target } from 'lucide-react';
...
export default function CommerceFinance() {
  const totalDegrees = commerceDegrees.length;
  const highDemandDegrees = commerceDegrees.filter(d => d.marketDemand.level === 'High').length;
  const avgSalaryRange = {
    min: Math.min(...commerceDegrees.map(d => d.salaryProgression.entryLevel)),
    max: Math.max(...commerceDegrees.map(d => d.salaryProgression.senior))
  };
        ...
        <div className="relative container mx-auto px-4 py-16">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground leading-tight">
              ...
              <span className="block text-primary mt-2">Commerce & Finance</span>
            </h1>
            
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Explore comprehensive business and finance career paths from traditional commerce to specialized financial programs. 
              Discover detailed insights into market demand, salary progression, and growth opportunities in the business world.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              to help you make informed decisions about your business and finance career.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {commerceDegrees.map((degree) => (
