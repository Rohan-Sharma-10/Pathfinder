...
import { ArrowLeft, Cpu, TrendingUp, Users, Target } from 'lucide-react';
...
export default function EngineeringTechnology() {
  const totalDegrees = engineeringDegrees.length;
  const highDemandDegrees = engineeringDegrees.filter(d => d.marketDemand.level === 'High').length;
  const avgSalaryRange = {
    min: Math.min(...engineeringDegrees.map(d => d.salaryProgression.entryLevel)),
    max: Math.max(...engineeringDegrees.map(d => d.salaryProgression.senior))
  };
        ...
        <div className="relative container mx-auto px-4 py-16">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground leading-tight">
              ...
              <span className="block text-primary mt-2">Engineering & Technology</span>
            </h1>
            
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Explore comprehensive engineering career paths from traditional core engineering to cutting-edge emerging technologies. 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              to help you make informed decisions about your engineering career.
            </p>
          </div>
