import { internationalDegreesData } from '@/data/IntRelations';
import { ArrowLeft, Globe, TrendingUp, Users, Target } from 'lucide-react';
...
export default function InternationalRelations() {
  const totalDegrees = internationalDegreesData.length;
  const highDemandDegrees = internationalDegreesData.filter(d => d.marketDemand.level === 'High').length;
  const avgSalaryRange = {
    min: Math.min(...internationalDegreesData.map(d => d.salaryProgression.entryLevel)),
    max: Math.max(...internationalDegreesData.map(d => d.salaryProgression.senior))
  };
        ...
        <div className="relative container mx-auto px-4 py-16">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground leading-tight">
              ...
              <span className="block text-primary mt-2">International Relations</span>
            </h1>
            
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Shape global affairs and diplomacy through comprehensive study of international politics, 
              global governance, and cross-cultural understanding with detailed career insights.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">
              Comprehensive Global Affairs Programs
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Each program includes detailed market analysis, career progression insights, and realistic salary expectations 
              to help you make informed decisions about your international relations career.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {internationalDegreesData.map((degree) => (
